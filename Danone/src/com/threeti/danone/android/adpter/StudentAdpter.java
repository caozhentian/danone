...
public class StudentAdpter extends CommonAdapter<Stool> {

	public StudentAdpter(Context context, List<Stool> mDatas, int itemLayoutId) {
		super(context, mDatas, itemLayoutId);
		// TODO Auto-generated constructor stub
	}

	@Override
	public void convert(ViewHolder helper, Stool item) {
